$(document).ready(function () {
    ...
    /**
     * Galeri :
     * - Perulangan menambahkan element card pada dom.
     */
    const parentDivGaleri = $('section.section.galeri div.container');
    const dataArrGaleri = {
        "row1": [{
            "jenisWeb": "Web Aplikasi",
            "namaWeb": "Bikinin Password1",
            "link": "https://bangef.github.io/bikin-password.gihub.io/"
        }, {
            "jenisWeb": "Web Aplikasi",
            "namaWeb": "Bikinin Password2",
            "link": "https://bangef.github.io/bikin-password.gihub.io/"
        }, {
            "jenisWeb": "Web Aplikasi",
            "namaWeb": "Bikinin Password3",
            "link": "https://bangef.github.io/bikin-password.gihub.io/"
        }],
        "row2": [{
            "jenisWeb": "Web Aplikasi",
            "namaWeb": "Bikinin Password",
            "link": "https://bangef.github.io/bikin-password.gihub.io/"
        }, {
            "jenisWeb": "Web Aplikasi",
            "namaWeb": "Bikinin Password",
    ...
    // $.each(dataArrGaleri.row1, function (i, currentVal) {
    //     $.each(currentVal, function (key, val) {
    //         let a = i + 1;
    //         if (a % 3 == 0) {
    //             $(parentDivGaleri).append(`<div class="row ${i + 1}"></div>`);
    //         }
    //         // if (i % 3 == 0) {
    //         //     console.log(val);

    //         // }
    //         // //     $('section.section.galeri div.container div.row').append(`<div class="col-md-4 col-sm-4">
